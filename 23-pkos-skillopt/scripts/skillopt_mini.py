...
与上游的差异（适配决策，均有意为之）：
  - 后端固定为 OpenAI-compatible HTTP（PKOS 网关 47.108.25.114:1519，
...
密钥：环境变量 PKOS_LLM_API_KEY（或 .env 的 HERMES_CUSTOM_*_API_KEY 之一）；
      ...
      --executor-key-env 可改），base_url 默认 http://47.108.25.114:1519/v1。
"""
...
DEFAULT_BASE_URL = "http://47.108.25.114:1519/v1"
