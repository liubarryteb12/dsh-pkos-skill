# 11-pkos-ppt-skill 实操手册（v2.0 原生 PPTX 线）
...
| `PKOS_IMG_CONFIG` | image-api config 路径（默认 `11-pkos-ppt-skill/shared/image-api/config.json`） |

## Agent 集成

```python
import sys; sys.path.insert(0, "11-pkos-ppt-skill/scripts")
