...
def sanitize(text: str) -> str:
    ...
    _user = _re.escape(os.environ.get("USERNAME", ""))
    text = _re.sub(r"C:[/\\]+Users[/\\]+" + _user + r"[/\\]+AppData[/\\]+Local[/\\]+hermes[/\\]+skills[/\\]+note-taking[/\\]+hermes-pkos-skill",
                   "<PKOS_SKILL_ROOT>", text)
    text = _re.sub(r"C:[/\\]+Users[/\\]+" + _user + r"[/\\]+AppData[/\\]+Local[/\\]+hermes", "<HERMES_APPDATA>", text)
    text = _re.sub(r"C:[/\\]+Users[/\\]+" + _user, "<LOCAL_HOME>", text)
